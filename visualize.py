...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Duong dan file anh output. Neu bo trong, se tu dat ten theo model.",
    )
    ...
    if args.model:
        ...
        candidates = sorted(results_dir.glob("model_Transformer*.pt"), key=lambda p: p.stat().st_mtime)
        if not candidates:
    ...
    if args.out:
        ...
        out_path = results_dir / f"attention_heatmap_{stem}.png"
